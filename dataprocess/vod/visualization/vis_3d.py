...
This method plots the annotations in the requested frame.
        ...
        for box in bboxes:
            ...
            object_class_color = class_colors[object_class] if object_class in class_colors else 0xFF0000
            object_class_width = class_width[object_class] if object_class in class_colors else 0.05
